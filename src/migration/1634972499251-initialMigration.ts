...
export class initialMigration1634972499251 implements MigrationInterface {
    name = 'initialMigration1634972499251'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sub_agent" ("id" SERIAL NOT NULL, "subAgencyNumber" character varying NOT NULL, "documentNumber" character varying NOT NULL, "name" character varying NOT NULL, "documentIdPhoto" character varying, "formNineHundred" character varying, "passportPhoto" character varying, "certificateGoodConduct" character varying, "dateOfUpdate" TIMESTAMP, "rut" character varying, "literalE" boolean, "patentNumber" character varying, "certificateNumber" character varying, "enabledDocument" character varying, "cesantiaDocument" character varying, "changeAddressDocument" character varying, "active" boolean, "agentId" integer, CONSTRAINT "UQ_4cdd997e197aad7ba6d9ad476bc" UNIQUE ("name"), CONSTRAINT "PK_b99bf5f574c0c3d8ace14ea11e3" PRIMARY KEY ("id"))`);
